...
export default function BackToTop() {
  ...
  return (
    <button
      ...
      className="fixed bottom-4 left-4 z-40 flex h-11 w-11 items-center justify-center rounded-full border border-slate-200 bg-white/90 text-slate-700 shadow-md backdrop-blur transition-transform duration-200 hover:scale-110 hover:text-primary-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600 sm:bottom-6 sm:left-6 dark:border-slate-700 dark:bg-slate-800/90 dark:text-slate-200"
    >
